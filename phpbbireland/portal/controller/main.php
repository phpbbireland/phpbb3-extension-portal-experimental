...
//?//var_dump('main.php > display()');
	...
	*/
	...
	{
//?//var_dump('main.php > base()');

		global $phpbb_container;
		global $k_config, $k_menus, $k_blocks, $k_pages, $k_groups, $k_resources;//, $block_modules;
		...
		///var_dump('main.pgp > base() > controller_helper->generate_all_block');
		//$this->controller_helper->generate_all_block();
		// process block modules //
		///$this->block_modules();
		// optional use func.php
...
//		$this->block_modules();
	...
	{
//?//var_dump('main.php > assign_images()');
	...
	*/
	...
	{
//?//var_dump('main.php > block_modules()');
	...
	{
//?//var_dump('main.php > build_block_modules($block_file)');
	...
	{
//?//var_dump('main.php > get_portal_cache()');
		global $k_config;
	...
	{
//?//var_dump('main.php > get_portal_link()');
